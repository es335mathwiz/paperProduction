...
when taking into account the cost of their construction.
As the size of the model increases, two of the three phases continue to be analytically tractable, but analytic expressions for 
