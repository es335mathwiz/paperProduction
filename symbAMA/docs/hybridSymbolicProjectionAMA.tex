...
Two numerical implementations, a  Matlab, a ``C''are available from the author. %\footnote{\url{http://www.federalreserve.gov/pubs/oss/oss4/aimindex.html}.} 
...
\input{ssSolnTimes.tex}

\input{allCompTimes.tex}
