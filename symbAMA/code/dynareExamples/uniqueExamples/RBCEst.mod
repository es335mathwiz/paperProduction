...
//alpha=.945946;//, beta_pdf, 0.35, 0.02;
//beta=.997984;//, beta_pdf, 0.99, 0.002;
//delta=.892857;//, beta_pdf, 0.025, 0.003;
//psi=.035;//, gamma_pdf, 1.75, 0.02;
//rho=.95;//, beta_pdf, 0.95, 0.05;
//epsilon=.03;//, gamma_pdf, 10, 0.003;
// from RBCMonopDet.mod
alpha   = 0.33;
beta    = 0.99;
delta   = 0.023;
psi     = 1.75;
