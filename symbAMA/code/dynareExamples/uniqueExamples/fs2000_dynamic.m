...
T90 = y(3)^params(1);
T92 = y(13)^(-params(1));
T93 = y(6)*(1-params(1))*T87*T90*T92;
T101 = y(13)^(1-params(1));
T102 = T90*T87*(1-params(1))*y(6)*params(2)*T101;
T147 = params(1)*exp((-params(1))*(params(3)+log(y(8))))*y(3)^(params(1)-1);
T152 = T101*T147+(1-params(7))*exp((-(params(3)+log(y(8)))));
...
g1(15,8)=(-(y(6)*params(2)*(T101*y(3)^(params(1)-1)*params(1)*exp((-params(1))*(params(3)+log(y(8))))*(-params(1))*1/y(8)+(1-params(7))*exp((-(params(3)+log(y(8)))))*(-(1/y(8))))/(y(5)*y(21)*y(20))));
g1(15,3)=(-(y(6)*params(2)*T101*params(1)*exp((-params(1))*(params(3)+log(y(8))))*getPowerDeriv(y(3),params(1)-1,1)/(y(5)*y(21)*y(20))));
g1(15,13)=(-(y(6)*params(2)*T147*T290/(y(5)*y(21)*y(20))));
g1(15,19)=1;
end
if nargout >= 3,
%
