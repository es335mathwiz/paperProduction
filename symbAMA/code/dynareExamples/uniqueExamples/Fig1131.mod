...
//modified varexo to parameters
parameters taui tauc tauk g;
g = 0.2;
tauc = 0;
taui = 0;
tauk = 0;
...
alpha=.33; 
A=1;
parameters ko;//ko now a parameter
ko=1;
...
//shocks;
//var g;  already defined as parameter
//periods 1:9;
//values 0.2;
//end;
...
co=ys0_(var_index('c'));
//ko = ys0_(var_index('k')); make ko a parameter
go = ex_(1,1);
