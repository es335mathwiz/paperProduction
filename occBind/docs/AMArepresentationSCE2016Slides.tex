...
\item High cost to control depending on dimension of state spacep
  \end{itemize}
...
system, through $H_1$,  must depend on expectational terms that can accomodate
