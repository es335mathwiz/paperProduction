...
$\sum_{s=k+1}^{\infty} F^s \phi \psi_z = (I -F)^{-1} F^{k+1}\phi \psi_z$}
      ...
      \label{eq:1}
\infNorm{\xWarg-\xWargK} \le\\ \infNorm{(I -F)^{-1} F^{k+1}\phi \psi_z} \left ( \infNorm{H_{-1} }+ \infNorm{H_{0} }+ \infNorm{H_{1} } \right )\bar{\mathcal{Z}}
    \end{gather}
...
\includegraphics[width=2in]{../../../AMASeriesRepresentation/AMASeriesRepresentation/arbTruncErr.pdf}  
...
\begin{figure}[H]
  \centering
\includegraphics[width=2in]{../../../AMASeriesRepresentation/AMASeriesRepresentation/arbTruncErrSimp.pdf}  
\includegraphics[width=2in]{../../../AMASeriesRepresentation/AMASeriesRepresentation/truncErrSimp.pdf}  
