...
\begin{gather*}
  \vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyEqns03RecA.pdf}}}\\
  \vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyEqns03RecB.pdf}}}\\
  \vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyEqns03RecC.pdf}}}\\
\end{gather*}
...
same complementary slackness conditions above.\footnote{The Piecewise solutions now appear to have four branches.  But, this
 ...
 \end{gather*}
  ...
  when imposing constraint for only two periods:
 \begin{gather*}
 \includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyhapp03RecA.pdf}
 \end{gather*}
 ...
 \end{gather*}
  ...
  when imposing constraint for only two periods:
 \begin{gather*}
 \includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyhapp03RecB.pdf}
 \end{gather*}
