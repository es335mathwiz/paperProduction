...
\underbrace{\xNowtp{0},0}\\
\underbrace{x_{t-1},0}
\underbrace{\xNow{1},\zNow{1}} 
\underbrace{\xNowtp{1},\ZNow{0}{1}{t}} 
\underbrace{\XNow{0}{t+2}{t},0}\\
\underbrace{x_{t-1},0}
\underbrace{\xNow{2},\zNow{2}} 
\underbrace{\xNowtp{2},\ZNow{1}{1}{t}} 
\underbrace{\XNow{1}{t+2}{t},\ZNow{0}{2}{t}} 
\underbrace{\XNow{0}{t+3}{t},0}\\
\end{gather}
\section{Examples}
\label{sec:examples}
