...
This paper proposes a new representation for time invariant functions; this representation can be to characterize solutions for a wide array of nonlinear rational expectations models.
The proposed approach allows computing accuracy bounds for any proposed time invariant model solution and also provides an algorithm for constructing approximate solutions for these nonlinear models.
In this context,
the series representation facilitates exploiting the ``law of iterated expectations'' in computing rational expectations solutions for models with occasionally binding constraints.
Best,
Gary
