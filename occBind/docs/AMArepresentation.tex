...
\begin{gather}
\vcenter{\hbox{\includegraphics{RBCParamSubs.pdf}}}\intertext{produces}
  \begin{bmatrix}
...
\begin{gather*}
\vcenter{\hbox{\includegraphics{truncErr.pdf}}}
\end{gather*}(\footnote{file generated by demoApprox.mth{truncErr.pdf}})
...
\begin{gather}
  \underbrace{0}  \underbrace{\zNow{0}}  \underbrace{0}\\
  \underbrace{0}  \underbrace{\zNow{1}} \underbrace{\ZNow{0}{1}{t}} \underbrace{0}\\
  \underbrace{0}  \underbrace{\zNow{2}} \underbrace{\ZNow{1}{1}{t}}\underbrace{\ZNow{0}{2}{t+1g}} \underbrace{0}\\
\end{gather}
\section{Examples}
\label{sec:examples}
