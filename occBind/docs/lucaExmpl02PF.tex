...
\begin{gather*}
  \vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyEqns02A.pdf}}}\\
  \vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyEqns02B.pdf}}}\\
\end{gather*}
...
\begin{gather*}
\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyrr02.pdf}
\end{gather*}
...
\begin{gather*}
  \vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyEqns02RecA.pdf}}}\\
  \vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyEqns02RecB.pdf}}}\\
\end{gather*}
...
same complementary slackness conditions above.\footnote{The Piecewise solutions now appear to have four branches.  But, this
 ...
 \end{gather*}
  ...
  when imposing constraint for only two periods:
 \begin{gather*}
 \includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyhapp02RecA.pdf}
 \end{gather*}
 ...
 \end{gather*}
  ...
  when imposing constraint for only two periods:
 \begin{gather*}
 \includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyhapp02RecB.pdf}
 \end{gather*}
...
\begin{gather*}
  0=\vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyreg02pltA.pdf}}}
\end{gather*}


\begin{gather*}
  0=\vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyreg02pltB.pdf}}}
\end{gather*}


\begin{gather*}
  0=\vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyreg02pltC.pdf}}}
\end{gather*}


\begin{gather*}
  0=\vcenter{\hbox{\includegraphics{../../../ProjectionMethodTools/ProjectionMethodToolsJava/code/prettyreg02pltD.pdf}}}
\end{gather*}
