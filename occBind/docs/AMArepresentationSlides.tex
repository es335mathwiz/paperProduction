...
formula \refeq{theSeries} to compute $x_t$.  It repeats this process until 
...
\item[ $\aleph$] uses the formula and a guess for $x^g_t$ for calculating conditional expectations for future variables to apply the formula \refeq{theSeries}
    \end{description}
