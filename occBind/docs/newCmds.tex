\newcommand{\zNow}[1]{z^#1_0(x_{t-1},\epsilon_t)}
\newcommand{\ZNow}[3]{\mathcal{Z}^#1_#2(x_{#3})}

\newcommand{\xNow}[1]{x^#1_t(x_{t-1},\epsilon_t)}
\newcommand{\xNowtp}[1]{x^#1_{t+1}(x_{t-1},\epsilon_t)}
\newcommand{\XNow}[3]{\mathcal{X}^#1_#2(x_{#3})}
